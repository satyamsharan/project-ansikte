...
export default function Page() {
  ...
  return (
    <div className="h-screen w-screen" >
      <LorenzAttractor />
      <div className={(!showInfoButton?`hidden`:``)+` info opacity-60 top-[40px] lg:top-[100px] max-w-lg select-none`}>
